...
author: "author"
date: "2025-04-05_17-49-49"
output:
  html_document: default
---


# Problem 001 (data row is 01) ((f, dfgrupos, g, n, sig, sqerros, sqtotal, dferros, sqgrupos, msqgrupos, dftotal))
...
# Problem 002 (data row is 02) ((f, dfgrupos, g, n, sig, sqerros, sqtotal, dferros, sqgrupos, msqgrupos))
...
# Problem 003 (data row is 03) ((f, dfgrupos, g, n, sig, sqerros, sqtotal, dferros, sqgrupos))
...
# Problem 004 (data row is 04) ((f, dfgrupos, g, n, sig, sqerros, dferros, sqgrupos))
...
# Problem 005 (data row is 05) ((f, dfgrupos, g, n, sqerros, dferros, sqgrupos))
...
# Problem 006 (data row is 01) ((dfgrupos, g, n, sqerros, dferros, sqgrupos))
...
# Problem 007 (data row is 02) ((dfgrupos, g, n, sqerros, sqgrupos))
...
# Problem 008 (data row is 03) ((dfgrupos, n, sqerros, sqgrupos))

Num estudo sobre a duração efetiva do efeito de fluidos isolantes a uma carga de 35KV,
foram analisados {:NUMERICAL:%100%4:0} tipos de fluidos e, para cada um deles, obtiveram-se **5.0** registos (em
horas). De seguida, efetuou-se uma ANOVA para avaliar possíveis diferenças médias entre os tipos de fluido. 

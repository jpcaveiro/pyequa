...
* \(z_\text{obs}\) = **1.6449**,
* valor-p = {:NUMERICAL:%100%0.05:0.01} = \( P(Z \ge  z_\text{obs}) \),
* \(\alpha\) = **0.01**
...
* \(z_\text{obs}\) = **2.3263**,
* valor-p = {:NUMERICAL:%100%0.01:0.01} = \( P(Z \ge  z_\text{obs}) \),
* \(\alpha\) = {:NUMERICAL:%100%0.05:0.01}
...
* \(z_\text{obs}\) = **0.5244**,
* valor-p = {:NUMERICAL:%100%0.3:0.01} = \( P(Z \ge  z_\text{obs}) \),
* \(\alpha\) = {:NUMERICAL:%100%0.05:0.01}
...
* \(z_\text{obs}\) = {:NUMERICAL:%100%3.0902:0.01},
* valor-p = {:NUMERICAL:%100%0.001:0.01} = \( P(Z \ge  z_\text{obs}) \),
* \(\alpha\) = **0.01**
